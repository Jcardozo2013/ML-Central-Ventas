...
public class SaleListenerService extends Service {
    ...
    private void listenLoop() {
        ...
        while (running) {
            ...
            try {
                ...
                conn.setRequestProperty("User-Agent", "MLCentralVentas/1.4 Android");
                int code = conn.getResponseCode();
                if (code < 200 || code >= 300) throw new IllegalStateException("HTTP " + code);
                SaleStore.setConnected(this, true);
                ReadSync.flushPendingAsync(this);
                updateServiceNotification("Conectado · esperando ventas y entregas");
                backoff = 2;
    ...
    private void handleMessage(JSONObject o) {
        ...
        // v1.4: las entregas son eventos separados. No entran al historial de ventas
        // ni modifican ventas nuevas/ganancias. Se deduplican por shipment_id.
        ...
        // v1.3: una corrección de Windows reemplaza la MISMA venta. No suena,
        // no aumenta ventas nuevas y no reaparece como no leída.
    ...
    private void showDeliveryNotification(String shipmentId, String title, String message) {
        ...
        ((NotificationManager) getSystemService(NOTIFICATION_SERVICE))
                .notify(2000000 + Math.abs(shipmentId.hashCode() % 900000), b.build());
    }

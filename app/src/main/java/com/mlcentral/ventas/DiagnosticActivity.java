...
public class DiagnosticActivity extends Activity {
    ...
    private void buildUi() {
        ...
        title.setText("ML Central · Diagnóstico v1.33");
        title.setTextSize(24);
        title.setGravity(Gravity.CENTER_HORIZONTAL);
        root.addView(title, full(0, 14));

        TextView help = new TextView(this);
        help.setText("Esta versión NO arranca el servicio sola. Primero muestra por qué Android cerró la ejecución anterior. Después podemos probar Firebase y el servicio por separado.");
        help.setTextSize(15);
        ...
        Button copy = button("Copiar informe");
        ...
        Button service = button("2 · Probar servicio de ventas");
    ...
    private void refreshReport() {
        ...
        try {
            ...
            if (rows == null || rows.isEmpty()) {
                ...
                out.append("ÚLTIMOS CIERRES REGISTRADOS POR ANDROID\n");
                out.append("=====================================\n");
                int i = 1;
    ...
    private void copyReport() {
        try {
            ...
            cm.setPrimaryClip(ClipData.newPlainText("ML Central diagnóstico", lastReport));
    ...
    private void testService() {
        Toast.makeText(this, "Iniciando servicio. Si la app se cierra, volvé a abrirla y copiá el informe.", Toast.LENGTH_LONG).show();
        try {
            Intent i = new Intent(this, SaleListenerService.class);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) startForegroundService(i);
            else startService(i);
        } catch (Throwable e) {
            Toast.makeText(this, "ERROR al iniciar servicio: " + e.getClass().getSimpleName() + " · " + String.valueOf(e.getMessage()), Toast.LENGTH_LONG).show();
        }
    }
}
